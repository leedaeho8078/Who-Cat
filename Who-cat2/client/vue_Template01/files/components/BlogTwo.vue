        ...
        <div class="col-xl-4 col-lg-6">
          <div class="blog_two_single wow fadeInLeft" data-wow-delay="300ms">
            ...
            <div class="blog-two_content">
              ...
              <h3>
                <nuxt-link to="/news_detail" class="blog_two_title"
                  >Agriculture Miracle you<br />Don't Know About</nuxt-link
                >
              </h3>
              <div class="blog_two_text">
                <p>
                  There are lorem ipsum is simply free text available in the
                  market to use it many variations of ipsum the majority
                  suffered.
                </p>
              </div>
        ...
        <div class="col-xl-4  col-lg-6">
          <div class="blog_two_single wow fadeInLeft" data-wow-delay="600ms">
            ...
            <div class="blog-two_content">
              ...
              <h3>
                <nuxt-link to="/news_detail" class="blog_two_title"
                  >Winter Wheat Harvest Gathering<br />Momentum</nuxt-link
                >
              </h3>
              <div class="blog_two_text">
                <p>
        ...
        <div class="col-xl-4">
          <div class="blog_two_right wow fadeInRight" data-wow-delay="300ms">
            <div class="blog_three_single">
              ...
              <h3>
                <nuxt-link to="/news_detail" class="blog_three_title"
                  >Amount of Freak Bread or Other Fruits</nuxt-link
                >
              </h3>
            </div>
            <div class="blog_three_single">
              ...
              <h3>
                <nuxt-link to="/news_detail" class="blog_three_title"
                  >Learn 10 Best Tips for New Formers</nuxt-link
                >
              </h3>
            </div>
            <div class="blog_three_single blgo_three_last">
              ...
              <h3>
                <nuxt-link to="/news_detail" class="blog_three_title"
                  >Winter Wheat Harvest Gathering Momentum</nuxt-link
                >
              </h3>
            </div>
          </div>
